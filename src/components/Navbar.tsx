...
const Navbar = () => {
  ...
  const getPlayerNavLinks = () => [
    ...
    { name: language === "en" ? "Our Team" : "Notre Équipe", href: "/team" },
  ];
  ...
  const navLinks = isAdmin
    ...
    : [
        { name: t("navbar.home"), href: "/" },
        { name: t("navbar.leaderboard"), href: "/leaderboard" },
        { name: language === "en" ? "Winners" : "Gagnants", href: "/winners" },
        {
          ...
          <div className="flex items-center justify-between h-16 relative">
            ...
            <div className="flex items-center flex-1 min-w-0 z-10">
              ...
              <div className="ml-2 min-w-0">
                <div className="text-xs font-medium text-foreground flex flex-col rounded-lg py-1 px-2 text-left">
                  {"Institut Spécialisé de Formation de l'Offshoring".split(" ")
                    .length > 3 ? (
                    <>
              ...
              {user || isAdmin ? (
                <>
                  <Button
                    ...
                    className="text-foreground hover:bg-battle-purple/10 hover:text-foreground mr-2 relative h-10 w-10"
                    title="Messages"
                    aria-label="Messages"
                  >
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button
                        className="flex items-center bg-gradient-to-r from-battle-purple to-indigo-600 rounded-full w-10 h-10 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer justify-center focus:outline-none focus:ring-2 focus:ring-battle-purple focus:ring-offset-2"
                    ...
                    <DropdownMenuContent align="end" className="w-64">
                      ...
                      {isAdmin && (
                        <>
                          ...
                          <DropdownMenuItem
                            onClick={() => {
                              navigate("/admin/player-histories");
                              setIsMenuOpen(false);
                            }}
                            className="cursor-pointer"
                          >
                ...
                <>
                  <Button
                    ...
                    className="text-foreground hover:bg-battle-purple/10 hover:text-foreground mr-2 h-10 w-10"
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={toggleMenu}
                    className="text-foreground hover:bg-battle-purple/10 hover:text-foreground h-10 w-10"
        ...
        <div className="hidden md:flex items-center justify-between h-16 w-full">
          ...
          <div className="flex-shrink-0 flex items-center">
            <img
              ...
              className="h-10 w-auto"
            />
            <div className="ml-3 text-sm font-medium text-foreground flex flex-col justify-center text-left">
              {"Institut Spécialisé de Formation de l'Offshoring".split(" ")
                .length > 3 ? (
                <>
                  <span>
              ...
              {isAdmin && (
                <div className="flex items-center space-x-3 mr-4">
                  <Button
                    ...
                    className="text-foreground hover:bg-battle-purple/10 hover:text-foreground relative h-10 w-10"
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button
                        className="flex items-center bg-gradient-to-r from-battle-purple to-indigo-600 rounded-full px-4 py-2 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-battle-purple focus:ring-offset-2"
                    ...
                    <DropdownMenuContent align="end" className="w-56">
                      ...
                      <DropdownMenuItem
                        onClick={() => navigate("/admin/player-histories")}
                        className="cursor-pointer"
                      >
                        <BookOpen className="w-4 h-4 mr-2" />
                        Player Histories
              ...
              {user ? (
                <div className="flex items-center space-x-2">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button
                        className="flex items-center bg-gradient-to-r from-battle-purple to-indigo-600 rounded-full px-3 py-2 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-battle-purple focus:ring-offset-2"
                        aria-label="User menu"
                      >
                ...
                !isAdmin && (
                  <>
                    ...
                    <Button
                      ...
                      className="border-battle-purple/50 hover:bg-battle-purple/10 hover:text-foreground h-10"
                    >
                      {t("navbar.login")}
                    </Button>
                  </>
                ...
                <Link
                  ...
                  className={`${
                    location.pathname === link.href
                      ? "text-foreground font-bold border-b-2 border-purple-700"
                      : "text-foreground/80 hover:text-foreground hover:border-b-2 hover:border-purple-700/50"
                  } transition-all duration-300 ease-in-out font-medium border-b-2 border-transparent px-2 py-3 whitespace-nowrap ${
                    language === "fr" ? "text-sm" : "text-base"
                  }`}
                ...
                {!user && !isAdmin && (
                  <>
                    <Button
                      ...
                      className="w-full border-battle-purple/50 hover:bg-battle-purple/10 hover:text-foreground h-12"
                    >
                      {t("navbar.login")}
                    </Button>
